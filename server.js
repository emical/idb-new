...
app.listen(PORT, (err) => {
  if (!err) {
    ...
    console.log(
      `\n${chalk.rgb(7, 54, 66).bgRgb(38, 139, 210)(' I ')} ${chalk.blue('Application is running at')} ${chalk
        .rgb(235, 220, 52)
        .bold(LOCALHOST)} ${chalk.blue('or')} ${chalk.rgb(235, 220, 52).bold(`http://${LOCALIP}:${PORT}`)}\n`
    )
  } else {
