...
export default function BikeloanDocumentsRequired(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Documents required to apply {bankName} Bike Loan</h1>
        <p>
          There are various list of documents required for {bankName} Bike Loan by various banks. You should submit the
          required document details along with a scanned copies of the relevant documents to proces of your {bankName}{' '}
          Bike Loan application. You can also submit your {bankName} Bike Loan application form and the required
          documents at the bank branch. Within 3 working days after you do so, the lender or bank will start
          investigating the submitted documents and check your eligibility for a {bankName} Bike Loan. If everything
          goes and authorized, verified, you would be sanctioned with a {bankName} Bike Loan disbursal to buy your dream
          bike.
        </p>
        <h2>{bankName} Bike Loan documents Salaried Employees:</h2>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Filled up {bankName} Bike Loan application form</li>
        ...
        <h2>{bankName} Bike Loan documents&nbsp; Self-Employed:</h2>
        <ul>
