...
export default function HomeloanApplyOnline(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>
          <strong>Step by step guide before having {bankName} home loan:</strong>
        </h1>
        <h2>
          <strong>
        ...
        <h2>
          <strong>
            Step 2 : Check loan approval status and legal documents &ndash; {bankName} home loan Calculator
          </strong>
        </h2>
        <p>
        ...
        <h2>
          <strong>Step 4 : Compare shortlisted banks | {bankName} home loan Calculator</strong>
        </h2>
        <p>
        ...
        <h2>Home&nbsp; Loan Application Process Online</h2>
        <p>
          If the Home&nbsp; Loan applicant has an existing relationship with the financial lender, he/she can apply for
          a Home&nbsp; Loan via his/her net banking account and could possibly be eligible for a pre-approval. For other
          customers, they can apply for a Home&nbsp; Loan online by following the steps mentioned below:
        </p>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Visit the website of the financial lender.</li>
          <li>&nbsp; &nbsp; &nbsp; Under the loan section, choose Home&nbsp; Loans.</li>
          <li>&nbsp; &nbsp; &nbsp; Click on the &lsquo;apply now&rsquo; option.</li>
          <li>
            &nbsp; &nbsp; &nbsp; Enter the details in the Home&nbsp; Loan application form and submit it to the bank.
          </li>
          <li>
        ...
        <h2>Home&nbsp; Loan application offline</h2>
        <p>Listed below is the process of applying for a Home&nbsp; Loan at the branch of the financial lender:</p>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Visit the branch of the financial lender</li>
          <li>&nbsp; &nbsp; &nbsp; Procure the Home&nbsp; Loan application form and enter all the required details.</li>
          <li>
        ...
        <h2>Email and phone banking requests Home&nbsp; loan:</h2>
        <p>
          You can leave a request for Home&nbsp; Loan with the bank through an email or at the customer service centre
          of the bank. The bank will review your eligibility and contact you to take the process further.
        </p>
        <p>&nbsp;</p>
      </div>
    </Grid>
