...
export default function StudentloanApplyOnline(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>
          <strong>{bankName} Student Loan Application Process:</strong>
        </h1>
        ...
        <h2>Step 2 : Check loan approval status and legal documents &ndash; {bankName} Student Loan Calculator</h2>
        <p>
        ...
        <p>
          ...
          bonuses and self-employed Student which is seasonal and has fluctuating cash flows. The interest rates on
        ...
        <h2>Step 4 : Compare shortlisted banks | {bankName} Student Loan Calculator</h2>
        <p>
        ...
        <h2>Step 5: Select the bank based on other service related parameters | {bankName} Student Loan Calculator</h2>
        <p>
        ...
        <p>&nbsp;</p>
        <h2>{bankName} Student Loan Application Process Online</h2>
        <p>
          If the {bankName} Student Loan applicant has an existing relationship with the financial lender, he/she can
          apply for a{bankName} Student Loan via his/her net banking account and could possibly be eligible for a
          pre-approval. For other customers, they can apply for a {bankName} Student Loan online by following the steps
          mentioned below:
        </p>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Visit the website of the financial lender.</li>
          <li>&nbsp; &nbsp; &nbsp; Under the loan section, choose {bankName} Student Loans.</li>
          <li>&nbsp; &nbsp; &nbsp; Click on the &lsquo;apply now&rsquo; option.</li>
          <li>
            &nbsp; &nbsp; &nbsp; Enter the details in the {bankName} Student Loan application form and submit it to the
            bank.
          </li>
          <li>
        ...
        <h2>{bankName} Student Loan application offline</h2>
        <p>
          Listed below is the process of applying for a {bankName} Student Loan at the branch of the financial lender:
        </p>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Visit the branch of the financial lender</li>
          <li>
            &nbsp; &nbsp; &nbsp; Procure the {bankName} Student Loan application form and enter all the required
            details.
          </li>
          <li>
        ...
        <h2>Email and phone banking requests for {bankName} Student Loan:</h2>
        <p>
          You can leave a request for {bankName} Student Loan with the bank through an email or at the customer service
