...
export default function SecondhandcarloanFactors(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Factors that Affect {bankName} second hand car loan</h1>
        <ul>
          <li>
            <strong>Principal</strong>- The principal is the {bankName} second hand car loan amount that you avail from
          ...
          <li>
            ...
            the {bankName} second hand car loan. It is also directly proportional to the value of your {bankName} second
            hand car loan EMIs.
          </li>
          <li>
            <strong>Tenure</strong>- The tenure is the time within which you repay your {bankName} second hand car loan.
        ...
        <h2>Things to consider that affect the {bankName} second hand car loan:</h2>
        <ol>
          <li>Income Levels</li>
