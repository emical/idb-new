...
export default function TwowheelerloanDocumentsRequired(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Documents required to apply {bankName} Two wheeler loan</h1>
        <p>
          There are various list of documents required for {bankName} Two wheeler loan by various banks. You should
          submit the required document details along with a scanned copies of the relevant documents to proces of your
          Two wheeler loan application. You can also submit your {bankName} Two wheeler loan application form and the
          required documents at the bank branch. Within 3 working days after you do so, the lender or bank will start
          investigating the submitted documents and check your eligibility for a {bankName} Two wheeler loan. If
          everything goes and authorized, verified, you would be sanctioned with a {bankName} Two wheeler loan disbursal
          to buy your dream Two wheeler.
        </p>
        <h2>{bankName} Two wheeler loan documents Salaried Employees:</h2>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Filled up {bankName} Two wheeler loan application form</li>
        ...
        <h2>{bankName} Two wheeler loan documents&nbsp; Self-Employed:</h2>
        <ul>
