...
export default function TwowheelerloanEligibility(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Eligibility Criteria for {bankName} Two wheeler loan</h1>
        <table>
          <tbody>
            <tr>
              <td>
              ...
              <td>
                <ul>
                  <li>
                    ...
                    <br /> Note: {bankName} Two wheeler loan amount depends upon the value of the Two wheeler and the
                    EMI you can pay
                  </li>
                </ul>
              </td>
        ...
        <h2>
          <strong>{bankName} Two wheeler loan&nbsp; Eligibility</strong>
        </h2>
        <p>
          <strong>Income Level of Individual</strong>
        </p>
        <p>
          Based on the income of the borrower, the {bankName} Two wheeler loan&nbsp; amount to be disbursed from the
          lender side will vary. Obviously, with a greater income sufficing the payment of EMIs without any discomfort,
          the Two wheeler loan&nbsp; amount disbursal can be much more. However, income levels are not much to deal with
          the pressure of higher EMIs, the lender or banker will most probably disburse a comparatively lower amount of
          Two wheeler loan&nbsp; so that the repayment from borrower side can be a lot smoother.
        </p>
        <p>
        ...
        <p>
          ...
          stability, higher the probability are the chances of more {bankName} Two wheeler loan&nbsp; amount coming your
          way.
        </p>
        <p>
        ...
        <p>
          &nbsp;All your trials of obtaining a {bankName} Two wheeler loan&nbsp; can go down in vain if you have a poor
          credit history resulting from a default in payments of credit cards or other loans prevously. So, please make
          sure you have and maintain a very good CIBIL score preferably above 750&nbsp; to get the {bankName} Two
          wheeler loan&nbsp; approved from most banks.
        </p>
        <p>&nbsp;</p>
        <p>
          <strong>Two wheelerType</strong> <strong>/ Vehicle Type</strong>
        </p>
        <p>
          The eligibility criteria also varies depending on type of Two wheelers you are buying. As you know, a wide
          range Two wheelers. The Two wheelers, which figure in these type /segment, are expected to have a slightly
          different resale value based on the model, reviews, engine performance and other features.
        </p>
        <p>
        ...
        <p>
          ...
          get a larger amount of {bankName} Two wheeler loan&nbsp; as lenders or banks will confirm your job stability
          to be pretty good. If you are not belong to such firms, it is necessary you must earn reasonably higher income
          so that a higher {bankName} Two wheeler loan&nbsp; amount could come running at your doorstep. Now that you
          know the critical major factors you should take care of while applying for a {bankName} Two wheeler loan , get
