...
export default function Autoloan(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <p>
          When one takes a {bankName} Auto loan, a natural question that comes to mind is how much the EMI would
          (Equated Monthly Installment) be that one must pay back to the bank every month.
        </p>
        <p>Hope the following FAQ&rsquo;s about {bankName} Auto loan will answer all your questions</p>
        <h2>
          {bankName} Auto loan Calculator &ndash; interest rates, eligibility criteria, application process, documents
          required, tax benefits, schemes in India
        </h2>
        <h2>What is {bankName} Auto loan Calculator?</h2>
        <p>
          A {bankName} Auto loan calculator helps you know the amount of the EMIs that you will need to pay towards your{' '}
          {bankName} Auto loan and helps make an informed decision. The{' '}
          <a href="https://emi-calculators.com/">EMI-Calculators.com'</a>s Auto loan calculator also functions as a{' '}
          {bankName} Auto loan interest calculator, as you will be able to know the interest amount due on your{' '}
          {bankName} Auto loan, in addition to the overall EMI amount, in just 3 simple steps. First, enter the loan
          amount that you wish to take. Then, select your preferred tenor. Finally, put in the {bankName} Auto loan
          interest rate advertised on the website. That's all!
        </p>
        <h2>What is {bankName} Auto loan?</h2>
        <p>
          EMI stands for Equated Monthly Instalment. EMI is the monthly repayment that a {bankName} Auto loan borrower
          must make to repay the {bankName} Auto loan within the specified loan tenor.
        </p>
        <p>
          The following table illustrates the EMI on several {bankName} Auto loan amounts with different tenures. The
          applicable rate of interest is 8.60%* onwards.
        </p>
        <h2>Factors that Affect {bankName} Auto loan</h2>
        <ul>
          <li>
        ...
        <h2>Eligibility Criteria for {bankName} Auto loan</h2>
        <table>
          <tbody>
            <tr>
              <td>
              ...
              <td>
                <p>21 Yrs. &ndash; 65 Yrs. Note: However, many banks require minimum age of 18 years</p>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <p>CIBIL Score for {bankName} Auto loan</p>
              </td>
              <td>
                <ul>
                  <li>
                    700 &amp; more credit history Note: Most banks avoid giving loans if you have low credit score
                  </li>
                </ul>
              </td>
            </tr>
        ...
        <p>&nbsp;</p>
        <h2>Documents required to apply {bankName} Auto loan</h2>
        ...
        <h2>{bankName} Auto loan for Different Loan Amounts</h2>
        <p>Following table shows the EMIs for various loan amount based on different tenures at 8.60%* onwards</p>
        <ul>
          <li>
            The EMI that you can avail with {bankName} Auto loan of 10 Lakh is 10,024 with 15-years tenure. The EMI
        ...
        <h2>Step by step guide before having {bankName} Auto loan:</h2>
        <h2>
          Step 1 : Check {bankName} Auto loan and calculate {bankName} Auto loan eligibility &ndash; {bankName} Auto
          loan Calculator
        </h2>
        <p>
        ...
        <h2>Step 2 : Check loan approval status and legal documents &ndash; {bankName} Auto loan Calculator</h2>
        <p>
        ...
        <h2>
          Step 3 : Decide on type of {bankName} Auto loan interest rate offers &ndash; {bankName} Auto loan Calculator
        </h2>
        <p>
          As you narrow down the list of banks in Step 2 and 3, you need to conduct an interest rate on {bankName} Auto
        ...
        <p>
          ...
          compared to floating rate loans and interest rate remains constant during the tenure of {bankName} Auto loan.
          In floating rate loan, interest rates are reset at periodic intervals in response to changes in MCLR and PLR
          rates of banks or NBFCs. Majority of {bankName} Auto loans in India today are floating rate loans as it allows
          the borrowers to get {bankName} Auto loan interest rate in line with the current interest rates.
        </p>
        <p>
        ...
        <h2>Step 4 : Compare shortlisted banks | {bankName} Auto loan Calculator</h2>
        <p>
          In addition to interest rates, banks also charge many other fees on {bankName} Auto loans. Along with interest
          ...
          costs on {bankName} Auto loan to be able to further shortlist the banks and reduce your choice to 2-3 banks.
        </p>

        <h2>
          Step 5 : Select the bank based on other service related parameters &nbsp;| &nbsp;{bankName} Auto loan
          Calculator
        </h2>
        <p>
        ...
        <h2>Comparison of {bankName} Auto loan Interest Rates in India</h2>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Processing fees</strong> &ndash; Most banks charges minimum processing fees of Nil
          to upto Rs.1,000. To get lowest fee, comparison of {bankName} Auto loan rates, offers and cashback applying
          online after comparison
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Insurance premium</strong> &ndash; {bankName} Auto loans are secured loans, but it
          is advisable to take an insurance policy when availing a loan. However, the premium varies from bank to bank
          depending upon the risk coverage under various policies. So, check the loan sanction letter Vehicleefully to
          know the coverage and premium.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Prepayment and foreclosure</strong> &ndash; When you want to repay your {bankName}{' '}
          Auto loan partially before time, it is called part prepayment. In case you decide to pay the entire {bankName}{' '}
          Auto loan amount before time, it is called foreclosure. Banks typically levy prepayment or foreclosure charges
          in such situations and these can range from nil to even upto 3%. So, check Vehicleefully if the low interest
          rate Auto loan you are getting comes with high prepayment or foreclosure charges. Note that some {bankName}{' '}
          Auto loans cannot be repaid before time.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Down payment</strong> &ndash; Banks offer {bankName} Auto loans either at 80% of
        ...
        <h2>Do&rsquo;s and Don&rsquo;ts while taking {bankName} Auto loan</h2>
        <p>
          To get best and lowest {bankName} Auto loan interest rates online, read the do&rsquo;s and don&rsquo;ts
          mentioned below.
        </p>
        <table width="694">
          <thead>
          ...
          <tbody>
              ...
              <td>
                <ul>
                  <li>
                    ...
                    Auto loan interest rates offered to employees of large reputed companies
                  </li>
                </ul>
              </td>
              <td>
            ...
            <tr>
              <td>
                <ul>
                  <li>
                    <strong>Compare Vehicle rates based on loan amount &ndash;</strong> Some banks offer lowest interest
                    rate for {bankName} Auto loan at higher loan amount
                  </li>
                  <li>
                    Vehicleefully decide on which type of insurance would be necessary - Comprehensive, Third Party, or
                    Zero Dep insurance. Check and compare the cost, coverage and claim settlement ratio.
                  </li>
                </ul>
              </td>
              <td>
                <ul>
                  <li>
                    ...
                    recorded in your CIBIL report and can hurt your chances of getting a {bankName} Auto loan
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              <td>
                <ul>
                  <li>
                    <strong>Discount for tenures &ndash;</strong> Banks may offer lower rates on {bankName} Auto loan
                    for certain tenure
                  </li>
                </ul>
              </td>
        ...
        <p>&nbsp;</p>
        <h2>Schemes under {bankName} Auto loan related to EMI and Interest</h2>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>EMI in arrears scheme</strong> &ndash; This is a standard method of paying EMI
          where the interest for a month (and principal repayment) is payable at or after the end of the month.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Advance EMI scheme</strong> &ndash; Under this scheme, you pay interest and EMI at
          the beginning of the month. So, each month, you pay interest on amount that you have already repaid to the
          bank at the beginning of the month.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Caution</strong> &ndash; In case your bank charges EMI in advance, the EMI amount
          should be about 1% lower than that in case of EMI in arrears. For those interested in more precise figures,
          EMI per Rs. 1 lakh loan amount on a 5 year {bankName} Auto loan at 10% rate of interest as per EMI in arrears
          method comes to Rs. 2,125 while that as per EMI in advance method comes to Rs. 2,107.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Zero interest scheme (also called 0% finance scheme)</strong> &ndash; This is one
          of those free lunches scheme that actually doesn&rsquo;t exist. So, beware of schemes that claim to offer zero
          interest. It is likely that the Vehicle company is offering a subvention scheme whereby the interest is paid
          by it to the bank upfront. Now, you could always ask the Vehicle dealer for the same amount as a cash
          discount. It&rsquo;s like padding up the price of the Vehicle for the interest amount and marketing it under a
          nice name.
        </p>
        <p>
          <strong>&nbsp;&nbsp;&nbsp; Flat rate of interest scheme</strong> &ndash; In this method, you pay interest on
          the entire principal amount of loan till maturity. So, on a loan of Rs. 5 lakhs at 10% for 5 years, you would
          have to pay back a total of Rs. 5 lakhs plus interest of Rs. 50,000 a year, that is a sum total of Rs.
          7,50,000. The EMI in this case would be Rs. 12,500.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Reducing balance scheme</strong> - In this method, you pay interest on the amount
          outstanding each month. With each EMI, the balance principal amount keeps reducing. So, on a Rs. 5 lakh loan
          at 10% for 5 years, you would have to pay back a total of Rs. 5 lakhs plus interest on reducing basis which
          comes to Rs. 1,37,411 or Rs. 6,37,411 including principal. The EMI in this case would be Rs. 10,624, a good
          15% less than that for a flat rate scheme.
        </p>
        <p>
          &nbsp;&nbsp;&nbsp; <strong>Caution</strong> &ndash; Never get hoodwinked with the low rate of interest offered
          on a flat rate scheme. A flat rate of 10% is equal to an interest rate of 18.7% on reducing rate basis on a 5
          year {bankName} Auto loan.
        </p>
        <h2>{bankName} Auto loan Calculator FAQs</h2>
        <Accordion>
        ...
        <ul>
          <li>
            {bankName} Auto loan processing fee: This is charged when you apply for the loan. The processing fee charged
            is upto Rs. 3,000 of the loan amount and could be reduced if you can bargain.
          </li>
          <li>
            {bankName} Auto loan pre-closure fee: This is charged when you close your loan before the completion of loan
            tenure. Prepayment penalty charged may be up to 5% of the outstanding amount.
          </li>
        </ul>
        <Accordion>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
        ...
        <h3>Is CIBIL Score for {bankName} Auto loan important?</h3>
        <p>
          CIBIL score is very important. Good CIBIL score indicates good repayment record and hence banks can offer you
          higher loan amount at low rate of interest for {bankName} Auto loan. Bad CIBIL Score will result in either
          loan at higher interest rate or rejection of the loan application. So, make all your payments on time and
          maintain your CIBIL in order to get best {bankName} Auto loan rates.
        </p>
        ...
        <h3>Can I get a loan for the full cost of my Vehicle?</h3>
        <p>
          Typically, banks loans only up to 80% to 90% of the total cost of the vehicle. However, there are a few banks
          that may cover the entire cost of the Vehicle.
        </p>
        <h3>Is a guarantor mandatory for a new {bankName} Auto loan?</h3>
        <p>
        ...
        <h3>Are all Vehicles financed by the loan institutions?</h3>
        <p>
          All small to medium sized Vehicles, Sport Utility Vehicles (SUV) and Multi Utility Vehicles (MUV) usually come
          under the {bankName} Auto loans finances available in India.
        </p>
        <h3>What is the minimum and maximum tenure of {bankName} Auto loan?</h3>
        <p>
          {bankName} Auto loan is generally taken for a short period of time. Generally, {bankName} Auto loan tenure is
        ...
        <p>
          ...
          is the price of the Vehicle including excise duty but excluding local duties and statutory charges.
        </p>
        <p>
          <strong>
            <u>On road price</u>
          </strong>{' '}
          is the price you pay for the Vehicle including the ex-showroom price and cost of registration, insurance,
        ...
        <p>
          Banks or NBFCs give Vehicle finance to those borrowers about whom they are sure that he/her can repay the
          loan. You need to know few things if you don&rsquo;t want your application to get rejected:
        </p>
        <ul>
          <li>
            Job stability for {bankName} Auto loan is important. You need to be stable in your current job as too many
            job changes can impact negatively at the time of loan approval
          </li>
          <li>
        ...
        <h3>What should I do if my {bankName} Auto loan application gets rejected by bank?</h3>
        <p>
        ...
        <h3>What is the interest rate on the {bankName} Auto loan?</h3>
        <p>
          The interest rate for a {bankName} Auto loan starts at 18.00%. The interest rates may vary across different
          Banks. Further, the interest factor is also dependent on the type of two-wheelers you wish to buy, the income
          of the applicant, age, and occupation.
        </p>
        <h3>How to finance a Vehicle?</h3>
        <p>
          Opting for a {bankName} Auto loan is the easiest way to finance a Vehicle. A variety of Banks and other
          lenders could provide you with funds to buy your dream Vehicle. However, one needs to meet the essential
          eligibility criteria and documentation requirements.
        </p>
        <h3>Can a student get a {bankName} Auto loan?</h3>
        <p>
          A student can apply for a {bankName} Auto loan if he or she fulfills the basic eligibility criteria. An
        ...
        <h3>How much can I pay as a down payment on a Vehicle?</h3>
        <p>
          A down payment usually ranges from 15-30% of the two-wheeler value. However, it may vary across the lender.
          The amount of down payment made on the two-wheeler will decide the EMI of the {bankName} Auto loan. The bigger
          the down payment, the lower the EMI.
        </p>
        <h3>What benefits do I get by calculating my EMI before taking an {bankName} Auto loan?</h3>
        ...
        <p>
          ...
          bank gives you may be a little different due to other charges involved in the calculation. Also, if your Auto
          loan is subject to a floating rate, then the interest rate changes every year based on the MCLR or base rate
          change. Even a slight change in interest rate will make a difference to the total loan amount you repay,
          depending on the duration of the loan. These variables limit the accuracy of an EMI calculator.
        </p>
        <h3>
        ...
        <h3>How is {bankName} Auto loan Calculated?</h3>
        <p>
        ...
        <h3>How to Calculate EMI for {bankName} Auto loan?</h3>
        <p>
          Calculating the EMI amount on your {bankName} Auto loan is quite easy. Simply enter the loan amount you wish
          to take, the tenor (in months, and not years) and the rate of interest, in the required fields.
        </p>
        <p>
          Once you find the EMI calculator for {bankName} Auto loan,&nbsp;To calculate the amount of EMI, you need to
        ...
        <h3>What are the Advantages of Knowing {bankName} Auto loan in Advance?</h3>
        <p>
          Good planning always ensures stable finances. Calculating the {bankName} Auto loan in advance gives a better
          understanding of the amount of money you would have to spend every month. Hence, you can plan well and decide
          whether you are able to spare that much money or not.
        </p>
        <h3>Components of a {bankName} Auto loan Calculator?</h3>
        <ol>
        ...
        <h3>How to use {bankName} Auto loan Calculator?</h3>
        <p>Using the EMI Calculator is a very simple process. All you need to do is follow these steps&ndash;</p>
        <ul>
          <li>Go the {bankName} Auto loan Calculator page</li>
          <li>Choose the loan amount, rate of interest, and tenor (in months)</li>
        </ul>
        <p>
          That's all! You will instantly get your {bankName} Auto loan amount along with the interest amount payable on
          the loan.
        </p>
        <h3>What are the Advantages of a {bankName} Auto loan Calculator?</h3>
        <p>
          A {bankName} Auto loan Calculator helps you to decide whether you can afford the financial commitment of a{' '}
          {bankName} Auto loan in the long term. If you want, you can increase or decrease your EMI amount depending on
        ...
        <p>
          ...
          they will be liable to pay for the pre-determined tenure and interest rate that the {bankName} Auto loans are
          offered, in mere seconds.
        </p>
        <p>
          <strong>Simplicity</strong> &ndash; The calculations using this EMI calculator for {bankName} Auto loan are
          based on the applicant providing three key bits of information i.e. the principal amount of the loan, the
          applicable rate of interest and the loan tenure.
        </p>
        <p>
          <strong>Varying Combinations</strong> &ndash; With the {bankName} Auto loan calculator, you can easily input
          different interest rates and tenures to look for a combination that will allow you to easily repay the
          principal amount, without putting undue pressure on your finances.
        </p>
        <p>
          Free Usage &ndash; The <a href="https://emi-calculators.com/">EMI-Calculators.com'</a>s {bankName} Auto loan
          calculator is a user friendly {bankName} Auto loan calculator that is available to everyone free of charge and
          is easy to use
        </p>
        <h3>What Is a {bankName} Auto loan Amortization Schedule?</h3>
        <p>
          A {bankName} Auto loan amortization schedule is the table or record which details all the periodic payments on
          your loan. This is generated through an amortization calculator.
        </p>
        <p>
        ...
        <h3>What are the factors that impact monthly {bankName} Auto loan?</h3>
        <p>
        ...
        <h3>
          What is Flat/Fixed Rate of Interest? And Flat/Fixed Rate of Interest Effect your EMI for {bankName} Auto loan?
        </h3>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            rate decreases, the fixed rate {bankName} Auto loan won&rsquo;t be benefited as the borrower will have to
            pay the same fixed amount every month.
          </li>
        </ul>
        <h3>
          What is Floating Rate of Interest? And Floating Rate of Interest Effect your EMI for {bankName} Auto loan?
        </h3>
        <p>
        ...
        <p>
          The online loan EMI calculator for {bankName} Auto loan can be used to calculate loan EMIs with a Floating
          rate of interest.
        </p>
        <p>
        ...
        <h3>Why should I use a {bankName} Auto loan calculator?</h3>
        <p>
        ...
        <h3>Will banks provide the {bankName} Auto loan calculator?</h3>
        <p>
          Yes. These days most, if not all, banks have {bankName} Auto loan calculator, specific to various loans,
          available on their websites.
        </p>
        <h3>How much should I pay as monthly EMI for {bankName} Auto loan?</h3>
        <p>
          Monthly EMI for {bankName} Auto loan depends upon your income and expenses. Generally, banks advise you to
        ...
        <h3>What if I miss EMI payment for {bankName} Auto loan or there is an ECS bounce?</h3>
        <p>
          If you miss your EMI payment on your {bankName} Auto loan or if there is an ECS bounce then bank may charge a
          penalty. In addition, it will also be reflected in your{' '}
        ...
        <h3>What if I get delay in paying the {bankName} Auto loan EMI?</h3>
        <p>
          Banks charges penalty for delaying EMI payment for {bankName} Auto loan. The amount of penalty varies from
          bank to bank.
        </p>
        ...
        <p>
          ...
          {bankName} Auto loan you should consider the stability of your income, monthly expenses and the existing loan
          obligations to avoid any discrepancies in future payments.
        </p>
        <p>
