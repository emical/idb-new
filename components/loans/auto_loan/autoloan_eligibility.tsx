...
export default function AutoloanEligibility(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Eligibility Criteria for {bankName} Auto loan</h1>
        <table>
          <tbody>
            <tr>
              <td>
              ...
              <td>
                <ul>
                  <li>
                    ...
                    <br /> Note: Most banks avoid giving {bankName} Auto loans if you have low credit score
                  </li>
                </ul>
              </td>
            </tr>
        ...
        <p>&nbsp;</p>
        <h2>
          <strong>{bankName} Auto loan Eligibility</strong>
        </h2>
        <h3>Income Level of Individual</h3>
        <p>
          Based on the income of the borrower, the {bankName} Auto loan amount to be disbursed from the lender side will
          vary. Obviously, with a greater income sufficing the payment of EMIs without any discomfort, the {bankName}{' '}
          Auto loan amount disbursal can be much more. However, income levels are not much to deal with the pressure of
          higher EMIs, the lender or banker will most probably disburse a comparatively lower amount of {bankName} Auto
        ...
        <p>
          ...
          stability, higher the probability are the chances of more {bankName} Auto loan amount coming your way.
        </p>
        <h3>Credit History</h3>
        <p>
          &nbsp;All your trials of obtaining a {bankName} Auto loan can go down in vain if you have a poor credit
          history resulting from a default in payments of credit cards or other loans prevously. So, please make sure
          you have and maintain a very good CIBIL score preferably above 750&nbsp; to get the {bankName} Auto loan
        ...
        <p>
          ...
          get a larger amount of {bankName} Auto loan as lenders or banks will confirm your job stability to be pretty
          good. If you are not belong to such firms, it is necessary you must earn reasonably higher income so that a
          higher auto loan amount could come running at your doorstep. Now that you know the critical major factors you
          should take care of while applying for a {bankName} Auto loan, get yourself aware of the eligibility params
          set by select lenders and banks in India.
        </p>
        <p>&nbsp;</p>
      </div>
    </Grid>
