...
export default function CarloanDocumentsRequired(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Documents required to apply {bankName} car loan</h1>
        <p>
          There are various list of documents required by various banks. You should submit the required document details
          along with a scanned copies of the relevant documents for processing of your {bankName} car loan application.
          You can also submit your {bankName} car loan application form and the required documents at the bank branch.
          Within 3 working days after you do so, the lender or bank will start investigating the submitted details and
          check your eligibility for a {bankName} car loan. If everything goes and authorized, you would be sanctioned
          with a hassle-free loan disbursal to buy your dream vehicle.
        </p>
        <h2>{bankName} car loan documents for Salaried Employees:</h2>
        <ul>
        ...
        <h2>{bankName} car loan documents for Self-Employed:</h2>
        <ul>
          <li>&nbsp; &nbsp; &nbsp; Filled up loan application form</li>
          <li>&nbsp; &nbsp; &nbsp; 2 Passport Size Photo</li>
          <li>
