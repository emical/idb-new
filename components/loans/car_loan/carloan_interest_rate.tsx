...
export default function CarloanInterestRates(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>{bankName} car loan Interest rate</h1>
        <p>
          {bankName} car loan Interest Rate starts from 9.20% and range is between 9.20%-11.25% per annum is feasible
          for most borrowers.
        </p>
        ...
        <p>&nbsp;</p>
        <p>
          Following table shows the EMIs for various Car &nbsp; loan amount based on different tenures at 8.60%* onwards
        </p>
        <ul>
          <li>
            &nbsp; The EMI that you can avail with {bankName} car loan of 10 Lakh is 10,024 with 15-years tenure. The
            EMI increases when you opt for tenure of 5 years.
          </li>
          <li>
            &nbsp; The EMI for a Car &nbsp; loan of 15 Lakh is higher &ndash; 30,992, when you opt for 5-years. It
            decreases to 15,036 if you opt for tenure of 15 years.
          </li>
          <li>
            &nbsp; For a {bankName} car loan of 25 Lakh, the cheapest EMI you can avail with 15 year tenure - 25,060.
            Decreasing the tenure to 5 years increases the EMI to 51,654.
          </li>
          <li>
            &nbsp; The EMI is 72,315 when you avail {bankName} car loan of 35 Lakh for 5 years. The same will decrease
            to 35,084 if you increase the tenure to 15 years.
          </li>
          <li>
            &nbsp; The cheapest EMI comes with 15-years tenure with&nbsp; Car &nbsp; loan of 50 Lakh &ndash; 50,120. The
