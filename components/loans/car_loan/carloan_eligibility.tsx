...
export default function CarloanEligibility(props: {bankname: string | string[] | undefined}) {
  ...
  return (
    <Grid item xs={12} md={8}>
      <div>
        <h1>Eligibility Criteria for {bankName} car loan</h1>
        <table>
          <tbody>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <p>CIBIL Score for {bankName} car loan</p>
              </td>
              <td>
                <ul>
                  <li>
                    700 &amp; more credit history
                    <br /> Note: Most banks avoid giving {bankName} car loans if you have low credit score
                  </li>
                </ul>
              </td>
            </tr>
        ...
        <p>&nbsp;</p>
        <h2>
          <strong>{bankName} car loan Eligibility</strong>
        </h2>
        <p>
          <strong>Income Level of Individual</strong>
        </p>
        <p>
          Based on the income of the borrower, the {bankName} car loan amount to be disbursed from the lender side will
          vary. Obviously, with a greater income sufficing the payment of EMIs without any discomfort, the {bankName}{' '}
          car loan amount disbursal can be much more. However, income levels are not much to deal with the pressure of
          higher EMIs, the lender or banker will most probably disburse a comparatively lower amount of {bankName} car
          loan so that the repayment from borrower side can be a lot smoother.
        </p>
        <p>
        ...
        <p>
          ...
          stability, higher the probability are the chances of more {bankName} car loan amount coming your way.
        </p>
        <p>
          <strong>Credit History</strong>
        </p>
        <p>
          &nbsp;All your trials of obtaining a {bankName} car loan can go down in vain if you have a poor credit history
          resulting from a default in payments of credit cards or other loans prevously. So, please make sure you have
          and maintain a very good CIBIL score preferably above 750&nbsp; to get the {bankName} car loan approved from
          most banks.
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          ...
          a smooth approval of the {bankName} car loan.
        </p>
        <p>&nbsp;</p>
        <p>
          <strong>Relationship with Bank</strong>&ndash; The strength of relationship with the lender/bank can either be
          a gain or loss-making proposition. If you are applying for a {bankName} car loan at a bank with whom you
          already have a successful journey in the form of CASA or other products, you could then negotiate for a higher{' '}
          {bankName} car loan amount at best interest rates.
        </p>
        <p>
          <strong>Business continuity for Self-employed</strong> &ndash; Businessmen or Self-employed professionals must
          be in the same business line for a minimum of 2-3 years to get the approval for a {bankName} car loan.
        </p>
        <p>
        ...
        <p>
          ...
          get a larger amount of {bankName} car loan as lenders or banks will confirm your job stability to be pretty
          good. If you are not belong to such firms, it is necessary you must earn reasonably higher income so that a
          higher {bankName} car loan amount could come running at your doorstep. Now that you know the critical major
          factors you should take care of while applying for a {bankName} car loan, get yourself aware of the
