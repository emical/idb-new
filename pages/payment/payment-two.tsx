...
const DreamCategory = ({data}: any) => {
  {
    ...
    const authorDescription3 =
      'We are charging a nominal fee of 2$ only, so that it helps us to help people like you, Insha Allah!'
          ...
          .Buttons({
            ...
            createOrder: function (data: any, actions: any) {
              return actions.order.create({
                purchase_units: [
                  {description: 'Personal dream interpretation service', amount: {currency_code: 'USD', value: 2}},
                ],
              })
            },
